...
- **The Entry Point is src/run.py**: I now know that the main entry point for running the application is `python src/run.py`, which dispatches commands to the phase-specific logic under `src/phases/`.
