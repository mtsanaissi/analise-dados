...
5.  **My Verification and Merge Workflow:**
    ...
    f. **Finalize Task:** I will update `@AGENT_TASKS.json` to move the completed task to the "done" list, removing acceptance criteria field while keeping all others.
